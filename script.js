...
//         let ballx = ballMove.x;
//         let bally = ballMove.y;
//         let ballWidth = ballMove.width;

//         let ballSpeedX = 2;
//         let ballSpeedY = 2;
//         // console.log("Ball Move X " + ballMove.x + "  Ball Move Y " + ballMove.y)

//         if(!gameon){
//             gameon=true;
//             // console.log(innerH, rod2H)
//             movement = setInterval(function(){
...
//                 ballx+= ballSpeedX;
//                 bally+= ballSpeedY;
//                 // console.log("Ball Y after change: " +bally)
//                 // console.log("After change: Ball Move X " + ballMove.x + "  Ball Move Y " + ballMove.y)
...
//                     ballSpeedY = -ballSpeedY; // Reverses the direction
//                     score++;
//                     console.log(bally, ballWidth)

//                     // End Game 

//                     if((ballPos < rod1.getBoundingClientRect().x) || ( ballPos > (rod1.getBoundingClientRect().x + rod1W))){
//                         storeWin(rd2, score);
//                     }
//                 }
...
//                     if((ballPos < rod2.getBoundingClientRect().x || ballPos > (rod2.getBoundingClientRect().x + rod2W))){
//                         storeWin(rd1, score);
//                     }
//                 }
